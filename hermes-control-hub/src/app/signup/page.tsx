...
export default function SignupPage() {
  ...
  const focusStyle = {
    borderColor: "rgba(77,208,248,0.5)",
    boxShadow: "0 0 0 3px rgba(77,208,248,0.08)",
  };
  const blurStyle = {
    ...
    <div className="min-h-screen flex items-center justify-center px-4" style={{ background: "#020305" }}>
      <div className="w-full max-w-sm">
        ...
        >
          ...
          <p className="text-sm text-white/40 mb-6">Join SpaceArmour Mission Control</p>
        ...
        <p className="text-center text-sm text-white/30 mt-5">
          ...
          <Link href="/login" className="text-[#4DD0F8] hover:text-[#7de0fa] transition-colors">
            Sign in
          </Link>
        </p>
      </div>
